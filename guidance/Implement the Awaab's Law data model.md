...
The SQL files contain [Data Definition Language (DDL)](https://github.com/data-futurists/damp-and-mould-standards-concept/tree/main/data%20definition%20language) scripts, which serve as setup scripts to:
